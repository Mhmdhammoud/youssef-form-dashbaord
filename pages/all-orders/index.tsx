        ...
        <React.Fragment>
            ...
            <Wrapper loading={loading}>
                <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-4xl pb-20 lg:max-w-[1600px]">
                    ...
                    >
                        <div
                            className="py-2 align-middle flex items-center min-w-full sm:px-6 lg:px-8 space-x-2 justify-between">
                            <div>
                                <button
                                    onClick={() => {
                                        //@ts-ignore
                    ...
                    />
                        ...
                        <div className="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                            ...
                            {filteredProducts && filteredProducts?.length > 0 && (
                                <nav
                                    className="border-t border-gray-200 px-4 flex items-center justify-between sm:px-0 mt-12">

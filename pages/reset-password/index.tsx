...
const Index = () => {
	...
	const isDisabled = Boolean(password.length < 6 || confirmPassword !== password)
						...
						<div>
							<Wrapper loading={loading} full={false}>
								<button
									type='submit'
									disabled={isDisabled}
									className={classnames('group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md focus:outline-none text-white focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500', isDisabled ? 'bg-gray-600 hover:bg-gray-700 cursor-not-allowed' : 'bg-indigo-600 hover:bg-indigo-700 cursor-pointer')}
								>

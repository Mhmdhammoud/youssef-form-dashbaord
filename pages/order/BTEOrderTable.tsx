...
const BTEOrderTable: React.FC<IProps> = ({order}) => {
    return (
                        ...
                        <table className='min-w-full divide-y divide-gray-200'>
                            ...
                            <tr className={'bg-white'}>
                                ...
                                {(order?.direction === OrderDirection.Left ||
                                    order?.direction === OrderDirection.Binaural) && (
                                    <td className='px-6 py-4 whitespace-nowrap text-sm text-gray-500'>
                                        {order?.product?.left?.manufacturer}
                                    </td>
                                )}
                                ...
                                {(order?.direction === OrderDirection.Right ||
                                    order?.direction === OrderDirection.Binaural) && (
                                    <td className='px-6 py-4 whitespace-nowrap text-sm text-gray-500'>
                                        {order?.product?.right?.manufacturer}
                                    </td>
                                )}
                            </tr>
                            <tr className={'bg-white'}>
                            ...
                            <tr className={'bg-white'}>
                                ...
                                {(order?.direction === OrderDirection.Left ||
                                    order?.direction === OrderDirection.Binaural) && (
                                    <td className='px-6 py-4 whitespace-nowrap text-sm text-gray-500'>
                                        {order?.material === 'biopor' &&
                                            order?.bioporShore === '25 Shore A' && (
                                        ...
                                        {order?.material === 'fototec' && order?.bioporShore === '' && (
                                            <span className={'p-1 flex items-center'}>
														{order?.product?.left?.color}
                                                <span
                                                    style={{
                            ...
                            <tr className={'bg-white'}>
                                ...
                                {(order?.direction === OrderDirection.Left ||
                                    ...
                                    <td className='px-6 py-4 whitespace-nowrap text-sm'>
												<span className={'p-1 flex items-center text-gray-500'}>
													{order?.product?.left?.soundTube}
                                                    <span
                                                        style={{
                                                            backgroundColor: soundTubeColor?.find(
                                                                (item) =>
                                                                    item.label === order?.product?.left?.soundTube,
                                                            )?.color,
                                                        }}
                                                        className={
                                                            'ml-4 p-1 w-6 h-6 rounded-full block border-[2px] border-black'
                                ...
                                {(order?.direction === OrderDirection.Right ||
                                    ...
                                    <td className='px-6 py-4 whitespace-nowrap text-sm'>
												<span className={'p-1 flex items-center  text-gray-500'}>
													{order?.product?.right?.soundTube}
                                                    <span
                                                        style={{
                                                            backgroundColor: soundTubeColor?.find(
                                                                (item) =>
                                                                    item.label === order?.product?.right?.soundTube,
                                                            )?.color,
                                                        }}
                                                        className={
                                                            'ml-4 p-1 w-6 h-6 rounded-full block border-[2px] border-black'

          ...
          <div className="bg-white shadow overflow-hidden sm:rounded-lg">
            ...
            <div className="border-t border-gray-200 px-4 py-5 print:py-0 sm:p-0 print:mt-[-10px]">
              <dl className="sm:divide-y sm:divide-gray-200">
                ...
                <div className="py-4 sm:py-5 sm:grid sm:grid-cols-2 sm:gap-4 sm:px-6 print:portrait:py-2">
                  <dt className="text-sm font-medium text-gray-500">
                ...
                <div className="py-4 sm:py-5 grid grid-cols-1 sm:gap-4 sm:px-6 print:portrait:py-1 print:portrait:mt-[-8px]">
                  <dt className="text-sm font-medium text-gray-500">
                    Product Info
                  </dt>

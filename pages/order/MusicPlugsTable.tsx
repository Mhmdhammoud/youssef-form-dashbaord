...
const SwimmingPlugsOrderTable: React.FC<IProps> = ({order}) => {
                ...
                <div className='py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8'>
                    <div className='shadow overflow-hidden border-b border-gray-200 sm:rounded-lg'>
                        <table className='min-w-full divide-y divide-gray-200'>
                                ...
                                {(order?.direction === OrderDirection.Left ||
                                    ...
                                    <td className='px-6 py-4 whitespace-nowrap text-sm text-gray-500'>
												<span className={'p-1 flex items-center'}>
                                                    ...
                                                    <span
                                                        style={{
                                                            backgroundColor: SwimmingPlugsColors.find(
                                                                (item) =>
                            ...
                            {(order?.product?.left?.engraving !== '' || order?.product?.right?.engraving !== '') && (
                                <tr className={'bg-white'}>
                                    <td className='px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900'>
                                        Engraving Text
                                    </td>
                                    {(order?.direction === OrderDirection.Left ||
                                        order?.direction === OrderDirection.Binaural) && (
                                        <td className='px-6 py-4 whitespace-nowrap text-sm text-gray-500'>
                                            {order?.product?.left?.engraving !== '' ? order?.product?.left?.engraving : ''}
                                        </td>
                                    )}
                                    {(order?.direction === OrderDirection.Right ||
                                        order?.direction === OrderDirection.Binaural) && (
                                        <td className='px-6 py-4 whitespace-nowrap text-sm text-gray-500'>
                                            {order?.product?.right?.engraving !== '' ? order?.product?.right?.engraving : ''}
                                        </td>
                                    )}
                                </tr>
                            )}
...
export default SwimmingPlugsOrderTable

...
const Container = (props: IContainerProps) => {
	...
	const [titleClasses, setTitleClasses] = useState<string>(
		classnames('text-center text-white py-2', !item && 'bg-gray-600')
	)
	const [containerClasses, setContainerClasses] = useState<string>(
		classnames(`w-full grid grid-cols-${cols}`, !item && 'border-gray-600 border-2')
	)
	// useEffect(() => {
	// 	setTitleClasses(
	// 		classnames('text-center text-white py-2', !item && 'bg-gray-600')
	// 	)
	// 	setContainerClasses(
	// 		classnames(`w-full columns-${cols}`, !item && 'border-gray-600 border-2')
	// 	)
	// }, [])
